...
* Linear Regression in Keras [C#](src/TensorFlowNET.Examples/BasicModels/LinearRegressionKeras.cs), [F#](src/TensorFlowNET.Examples/BasicModels/LinearRegressionKeras.cs)
